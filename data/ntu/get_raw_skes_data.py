...
if __name__ == '__main__':
    save_path = '/lsdf/users/kpeng-fy2374/workspaces/skeletons/ntu60/'

    skes_path = '/cvhci/data/activity/NTU_RGBD/zipped/zipped_skeleton_csv/nturgb+d_skeletons/'
    stat_path = osp.join(save_path, 'statistics')
    if not osp.exists('/lsdf/users/kpeng-fy2374/workspaces/skeletons/ntu60//raw_data'):
        os.makedirs('/lsdf/users/kpeng-fy2374/workspaces/skeletons/ntu60//raw_data')
